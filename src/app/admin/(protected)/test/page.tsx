export default function AdminTestPage() {
    return (
        <main style={{ padding: 24, fontFamily: "system-ui", maxWidth: 800, margin: "0 auto" }}>
            ...
            >
                <h2 style={{ margin: "0 0 8px 0", color: "#155724" }}>🔒 Guard OK</h2>
                <p style={{ margin: 0, color: "#155724" }}>
                    Nếu bạn thấy trang này, nghĩa là bạn đã đăng nhập và vượt qua guard thành công.
                </p>
            </div>
            ...
            <div style={{ padding: 20, backgroundColor: "#f8f9fa", borderRadius: 8 }}>
                ...
                <ul style={{ lineHeight: 1.8 }}>
                    <li>
                        <strong>URL:</strong> <code>/admin/test</code>
                    </li>
                    <li>
